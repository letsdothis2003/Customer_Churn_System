...
public class DataSetTest {
    ...
    @Before
    public void setUp() {
        dataSet = new DataSet("C:\\Users\\Admin\\eclipse-workspace\\RandomForest\\src\\DataLayer\\DataFile (updated).csv"); // Use a dummy path as we're injecting data directly
    ...
    public void testImputation() {
        ...
        dataSet.imputeData(); // Perform imputation
